...
const SearchPage = () => {
  ...
  return (
  <div className={`top-4 justify-between items-start space bg-gradient-to-b to-black ${color} h-40 text-[#E4E4E7] p-8 w-full`}>
      <Navbar color={color} />
    <div className="h-screen flex flex-col items-center justify-start mt-32 text-center overflow-hidden text-white">
      ...
      <div className="flex flex-col items-center justify-center">
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <form onSubmit={handleSearch} className="mt-8" autoComplete="off">
              <div className="flex">
    ...
    <Footer className="w-[100%] mx-0 text-[rgb(128, 128, 128)]" color={color} />
  </div>
  </div>
);
};
